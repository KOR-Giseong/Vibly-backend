...
const CATEGORY_IMAGE = {
    ...
    ESCAPE: 'https://images.unsplash.com/photo-1559181567-c3190e52d8e4?w=400&q=80',
    ARCADE: 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=400&q=80',
...
let KakaoService = KakaoService_1 = class KakaoService {
    ...
    async searchNearby(lat, lng, radiusM = 2000, page = 1, limit = 20) {
